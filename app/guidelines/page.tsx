...
const Guidelines: React.FC = () => {
  ...
  const guidelines: GuidelineItem[] = [
    ...
    {
      icon: (
        <Thermometer className="text-[#011A2EB2] stroke-[1.67px]" size={24} />
      ),
      text: "Minimize heat paths to outside.",
      category: "thermal",
    },
    {
      icon: <Fan className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
      text: "Adequate ventilation - muffin fans to cool cap and base.",
      category: "thermal",
    },
    {
      icon: (
        <ShipWheel className="text-[#011A2EB2] stroke-[1.67px]" size={24} />
      ),
    ...
    // Mechanical
    {
      icon: <Boxes className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
      text: "Apply as much as possible one piece instead of multiple pieces.",
      category: "mechanical",
    },
    {
      icon: <Shield className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
      text: "Review structural members for acceptable stress and deflection.",
      category: "mechanical",
    },
    {
      icon: (
        <RotateCcw className="text-[#011A2EB2] stroke-[1.67px]" size={24} />
      ),
    ...
    {
      icon: <Square className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
      text: "Flat on all shafts where set screw bear.",
      category: "mechanical",
    },
    {
      icon: <Link className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
      text: "Provision for routing of drive chains.",
      category: "mechanical",
    },
    {
      icon: (
        <AlertTriangle className="text-[#011A2EB2] stroke-[1.67px]" size={24} />
      ),
      text: "Review design for interference between subsystems.",
      category: "mechanical",
    },
    {
      icon: <Power className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
    ...
    {
      icon: (
        <Container className="text-[#011A2EB2] stroke-[1.67px]" size={24} />
      ),
    ...
    {
      icon: (
        <SwitchCamera className="text-[#011A2EB2] stroke-[1.67px]" size={24} />
      ),
    ...
    {
      icon: <Cog className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
      text: "Provisions for mounting of all drive motors and encoders.",
      category: "assembly",
    },
    // Logistics
    {
      icon: <Truck className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
      text: "Effects of shipping considered in the design (i.e. vibration, low temperatures, and shock loads).",
      category: "logistics",
    },
    {
      icon: <Anchor className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
      text: "Provisions made for shipping (i.e. holes for anchoring to a skid).",
      category: "logistics",
    },
    {
      icon: (
        <ShoppingCart className="text-[#011A2EB2] stroke-[1.67px]" size={24} />
      ),
    ...
    {
      icon: (
        <Paintbrush className="text-[#011A2EB2] stroke-[1.67px]" size={24} />
      ),
    ...
    {
      icon: (
        <FileCheck className="text-[#011A2EB2] stroke-[1.67px]" size={24} />
      ),
      text: "Appropriate drawings been marked 'make from' or 'similar to' to save time at vendor.",
      category: "specifications",
    },
    {
      icon: <Ruler className="text-[#011A2EB2] stroke-[1.67px]" size={24} />,
  ...
  return (
    <div className="min-h-screen bg-white p-12">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <TabsList className="w-full flex justify-start bg-transparent h-auto space-x-6 p-0">
            <TooltipProvider>
